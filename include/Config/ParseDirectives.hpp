...
/*   Updated: 2024/05/16 20:50:25 by rjobert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class	ParseDirectives {
	public:
		...
		static int	parseServerConfig( Directives *, StrVector &, int );
		//static int	parseLocation( Directives *, StrVector &, int );
		static int	parseServerConfigDirectives( Directives *, StrVector &, int , StrVector &, int );
		...
		static void	save_ServerConfig_name( Directives *, StrVector & );
