...
#    Updated: 2024/03/29 13:01:41 by rjobert          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME = main.cpp networking/Socket.cpp server/Server.cpp http/Header.cpp
INC_NAME = Socket.hpp Server.hpp Location.hpp Header.hpp
